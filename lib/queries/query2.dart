...
class Query2 extends StatefulWidget {
  Query2({Key? key, required this.conn, required this.branch})
      : super(key: key);
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              FutureBuilder(
                future: widget.conn
                    .execute("select * from staff where position= 'Assistant' and staff_branch='${widget.branch}' order by full_name"),
